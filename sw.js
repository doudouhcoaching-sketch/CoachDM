// Coach DM — Service Worker minimal (installabilité PWA Android)
// Pas de cache agressif : on laisse Supabase/réseau gérer les données fraîches.
const CACHE_NAME = "coachdm-shell-v1";
